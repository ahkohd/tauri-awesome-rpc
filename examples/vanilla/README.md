...
- `src-tauri/` - Rust backend code
  - `main.rs` - Main application setup with AwesomeRpc integration
  - `tauri.conf.json` - Tauri v2 configuration
  - `capabilities/` - Permission configuration for Tauri v2
- `src/` - Frontend TypeScript code
  - `main.ts` - Example usage of invoke and event listening
